                            ...
                            <div class="table-responsive">
                                <table class="table mg-b-0 text-md-nowrap">
                                    ...
                                    <tr v-for="entry in entries">
                                        ...
                                        <td>
                                            <switch-button v-model="entry.share_data" @change="shareData(entry)"></switch-button>
                                        </td>
                                        <td>
                                            <switch-button v-model="entry.status" @change="toggleStatus(entry)"></switch-button>
                                        </td>
                                        <td>
                                            <switch-button v-model="entry.open_next_day" @change="openNextDay(entry)"></switch-button>
                                        </td>
                                        <td class="">
    ...
    export default {
        ...
        methods: {
            ...
            async openNextDay(entry) {
                const res = await $post('/xadmin/campaign_partners/openNextDay', {
                    id: entry.id,
                    open_next_day: entry.open_next_day
                });
            ...
            async shareData(entry) {
                const res = await $post('/xadmin/campaign_partners/shareData', {
                    id: entry.id,
                    share_data: entry.share_data
                });
