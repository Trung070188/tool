                    ...
                    <div class="card">
                        <div class="card-header pb-0">
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">Chi tiết thống kê</h4></div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-xl-8">
...
<!--                                        </div>-->
                                        ...
                                        <div class="form-group mx-sm-3 mb-2">
                                            ...
                                            <select class="form-control js-example-responsive" v-model="filter.customer">
                            ...
                            <div class="table-responsive">
                                <table class="table mg-b-0 text-md-nowrap">
                                    ...
                                    <tr v-for="(entry,index) in entries">
                                        ...
                                        <td>
                                            <a :href="'/xadmin/debt_settle/debt#?customer_id=' +entry.customer_id + '&year=' + this.filter.year + '&month=' + this.filter.month"
                                               target="_blank">{{ entry.pay_booking }} </a>
                                        </td>
                                        <td>
                                            <a :href="'/xadmin/debt_settle/index#?customer_id=' + entry.customer_id +'&year=' + this.filter.year + '&month=' + this.filter.month"
                                               target="_blank">{{ entry.pay_debt }} </a>
                                        </td>
                                        <td>{{ entry.owe }}</td>
